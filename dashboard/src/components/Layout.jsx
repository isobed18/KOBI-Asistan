...
function NotificationBell() {
  ...
  return (
    <div className="notif-bell-wrap" ref={ref}>
      <button className={`notif-bell-btn${unread > 0 ? ' has-unread' : ''}`} onClick={() => setOpen(v => !v)} title="Bildirimler">
        <span>!</span>
      ...
      <div className="main">
        <div className="topbar command-topbar">
          ...
          <div className="topbar-actions">
            <button className="btn btn-ghost btn-sm topbar-theme-btn" onClick={() => setTheme(t => t === 'dark' ? 'light' : 'dark')}>
            ...
            {user && (
              <div className="topbar-user">
                ...
                <button className="btn btn-ghost btn-sm" onClick={handleLogout}>Cikis</button>
              </div>
            )}
          </div>
        </div>
